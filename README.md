...
Aplicação usando React Native, Axios, React Navigation, Formik, Yup, react-native-slider, ESLint, prop-types e color executando um CRUD na [Node.js - Express API](https://github.com/osvaldokalvaitir/nodejs-express-api).
